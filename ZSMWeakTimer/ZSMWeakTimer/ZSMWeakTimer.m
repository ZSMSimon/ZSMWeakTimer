...
#import "ZSMWeakTimer.h"
#import <libkern/OSAtomic.h>
#import <stdatomic.h>

/**
 避免在MRC中使用，抱歉！我MRC忘记的差不多了！
 */
#if !__has_feature(objc_arc)
#error ZSMeakTimer is ARC only. Either turn on ARC for the project or use -fobjc-arc flag
#endif
...
+ (instancetype)scheduledTimerWithTimeInterval:(NSTimeInterval)timeInterval
                                 ...
                                 dispatchQueue:(dispatch_queue_t)dispatchQueue
{
    ZSMWeakTimer *timer = [[self alloc] initWithTimeInterval:timeInterval
                                                     target:target
                                                   selector:selector
                                                   userInfo:userInfo
                                                    repeats:repeats
...
- (void)schedule
{
    ...
    __weak ZSMWeakTimer *weakSelf = self;
